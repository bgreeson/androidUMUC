...
public class StorageTool
{
    ...
    public static String createMsg(String userID, String targetUserID, String sourceFileUri)
    {
        ...
        try
        {
            ...
            URL url = new URL("http://androidsoundappproject.appspot.com/server?action=message_create");
    ...
    public static String getMsgCount(String targetUserID)
    {
        ...
        {            
            ...
            messageCount += IOUtils.toString(is);
    ...
    public static String getRcvdMsgList(String targetUserID, String newList)
    {
        ...
        {            
            ...
            InputStream is = conn.getInputStream();
            messageList += IOUtils.toString(is);
    ...
    public static String getSentMsgList(String userID)
    {
        ...
        try
        {            
            url = new URL("http://androidsoundappproject.appspot.com/server?user_id_sender=" + userID 
                    + "&action=message_sent");
    ...
    public static String getMsgInfo(String msgID)
    {
        ...
        try
        {            
            url = new URL("http://androidsoundappproject.appspot.com/server?msg_id=" + msgID 
                    + "&action=message_info");
            ...
            InputStream is = conn.getInputStream();
            messageInfo += IOUtils.toString(is);
